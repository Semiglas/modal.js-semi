...
})({"6ucez":[function(require,module,exports) {
...
const modal = new (0, _modalJs.Modal)();
console.log((0, _modalJs.Modal));

},{"./styles.scss":"gmH49","./modal.js":"fYPXV"}],"gmH49":[function() {},{}],"fYPXV":[function(require,module,exports) {
...
class Modal {
    ...
    listenForButtons() {
        ...
        this.$selector.querySelector("[data-type='modal__close-button']").addEventListener("click", ()=>{
            this.close();
        });
    }
    // TODO GUI dodelat' 
...
background: url(path/to/your/image);
    ...
    */ disableScrollEffect() {
        if (document.querySelector(".visible")) document.querySelector("body").style.overflow = "hidden";
    }
    clickOutside() {
    ...
    convertToRGB(color) {
        if (!color) return;
        if (color.startsWith("#")) {
            if (color.length != 7) throw "Only six-digit hex colors are allowed.";
        ...
        } else if (color.startsWith("rgb")) return color;
        else throw "Unknown color format.";
    }
}

},{"@parcel/transformer-js/src/esmodule-helpers.js":"1Sj8x"}],"1Sj8x":[function(require,module,exports) {
...
},{}]},["6ucez","bB7Pu"], "bB7Pu", "parcelRequire2c89")
